...
def join_frames(frames_path, output, workload_name):
    if not os.path.isdir(frames_path):
    ...
    for count in range(0,len(frames)):
        ...
        filename = "{}/f{}_{}.png".format(frames_path,count + 1, workload_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-workload_name", default="myworkload", help="Workload name is needed for path")
    ...
    if args.action == 'extract':
        ...
        join_frames(args.frames_path, args.video, args.workload_name)
    else:
        parser.print_help()